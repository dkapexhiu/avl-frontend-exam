    ...
    <Theme>
      <Wrapper>
        <SideBar>
		  ...
		  <p className="bottomTxt" style={{color: "grey", position: "absolute", bottom: 0}}>Past 24 Hours, 2020 2/20</p>
        </SideBar>
        <Page>
          <SelectorBar>
          ...
          <MainPane>
            ...
            <PaneContent>
              <PaneContentLeft>
				...
				<div />
				<ChartTitle text1="Number of Portable Media Players" text2="Sold Worldwide Each Year from 2006 to 2011" />
				<Label text="Number Sold (millions)" rotate />
